...
class TestXiecheng():
    ...
    def day4(self):
        ...
        self.driver.find_element(By.ID, "DdateObj").send_keys("2020-09-16")
        self.driver.find_element(By.ID, "notice02").send_keys("合肥")
        time.sleep(8)
        self.driver.find_element(By.ID, "searchTicket").click()
        time.sleep(8)
        self.driver.find_element_by_class_name("w6")(By.CSS_SELECTOR,
                                                     ".railway_list:nth-child(2) div:nth-child(1) > .qp_btn2").click()
